...
const ResetPassword = () => {
    return (
        <>
            ...
            <Container className="reset-password-wrapper min_height d-flex justify-content-center align-items-center">
                <div className="row">
                    <div className="col-12 d-flex justify-content-center align-items-center">
                        <div className="auth-card">
                            <form>
                                ...
                                <CustomInput
                                    type="password" name='password' placeholder='New Password' id="exampleInputPassword1"
                                />
                                <CustomInput
